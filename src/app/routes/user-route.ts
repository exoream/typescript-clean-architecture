...
userRoute.delete("/users/:id", jwtMiddleware, userController.delete.bind(userController));
userRoute.put("/users/:id", jwtMiddleware, userController.update.bind(userController));
